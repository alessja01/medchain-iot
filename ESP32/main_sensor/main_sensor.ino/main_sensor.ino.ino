...
//CONFIG MAX30205
Adafruit_MAX30205 tempSensor = Adafruit_MAX30205();
...
void setup() {
  ...
  Serial.println("Avvio ESP32 - DHT11 + MQTT");

  dht.begin(); // inzializza il sensore DHT11
  setup_wifi(); // connessione al Wifi

  Wire.begin(); //inizializzo sensore
  tempSensor.begin();//temperatura inizializzo
